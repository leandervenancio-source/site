      ...
      <section className="pt-36 pb-20 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg sm:text-xl text-branco/70 font-light leading-relaxed mb-6 max-w-3xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-5 justify-center items-center">
              <Link 
                to="/diagnostico" 
                className="w-full sm:w-auto px-10 py-5 text-xs font-bold uppercase tracking-[0.2em] text-obsidian bg-accent-premium hover:bg-white transition-all duration-500 rounded-full text-center shadow-lg shadow-accent-premium/20"
              >
      ...
      <section className="py-20 bg-white/5 border-y border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-3 gap-8">
            {benefits.map((b, i) => (
              <div key={i} className="p-8 bg-obsidian/70 border border-white/10 rounded-2xl">
                <div className="w-10 h-10 rounded-xl bg-accent-premium/10 flex items-center justify-center text-accent-premium mb-6">
                  <b.icon className="w-5 h-5" />
                </div>
                <h3 className="text-xl font-display font-medium text-branco mb-3">{b.title}</h3>
                <p className="text-sm text-branco/60 font-light leading-relaxed">{b.desc}</p>
              </div>
            ))}
          </div>
        </div>
              ...
              <div key={s.num} className="p-8 bg-white/[0.03] border border-white/10 hover:border-accent-premium/50 transition-all duration-300 rounded-2xl flex flex-col justify-between group">
                <div>
                  <div className="flex items-center justify-between mb-6">
                    <span className="text-xs font-mono font-semibold text-accent-premium tracking-widest">{s.num}</span>
                  ...
                  <h3 className="text-xl font-display font-medium text-branco mb-3">{s.title}</h3>
                  <p className="text-sm text-branco/60 font-light leading-relaxed">{s.desc}</p>
                </div>
              </div>
            ))}
          </div>
